...
<div
    ...
    class="flash-message flash-message--info flex items-start gap-3 rounded-lg border-l-4 border-primary bg-secondary/20 px-4 py-3 shadow-lg w-80"
>
    <i class="flash-message-icon fa-solid fa-circle-info text-primary text-base mt-0.5 flex-shrink-0" aria-hidden="true"></i>
