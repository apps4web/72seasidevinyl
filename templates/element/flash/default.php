...
<div
    ...
    class="flash-message flex items-start gap-3 rounded-lg border-l-4 border-stroke bg-gray-2 px-4 py-3 shadow-lg w-80"
>
    <i class="flash-message-icon fa-solid fa-circle-info text-gray-4 text-base mt-0.5 flex-shrink-0" aria-hidden="true"></i>
