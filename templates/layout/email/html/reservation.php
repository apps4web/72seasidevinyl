            ...
            <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="max-width:640px; background:#0e4143; border:1px solid #c9a84c; border-radius:6px; overflow:hidden;">
                <tr>
                    <td align="center" style="padding:24px 20px 14px; background:#0c2e31; border-bottom:1px solid rgba(201,168,76,0.35);">
                        ...
                        <div style="color:#93c8cb; font-size:12px; letter-spacing:2px; text-transform:uppercase; margin-top:6px;">Reservering</div>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="padding:16px 24px; background:#0c2e31; border-top:1px solid rgba(201,168,76,0.2); text-align:center;">
                        <p style="margin:0; font-size:12px; color:#93c8cb;">72 Seaside Vinyl &mdash; Sint Domusstraat 17, Zierikzee</p>
                    </td>
                </tr>
            </table>
        </td>
